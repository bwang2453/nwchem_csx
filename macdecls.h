...
/* 
 * $Id: macdecls.h,v 1.18.6.1 2006-12-14 13:24:53 manoj Exp $
 */
...
extern Boolean MA_initialized(void);
...
extern void MA_summarize_allocated_blocks(void);
extern void MA_trace(Boolean value);
extern Boolean MA_verify_allocator_stuff(void);
extern void MA_set_error_callback(void(*func)(void));
#else
extern Boolean MA_alloc_get(void);
extern Boolean MA_allocate_heap(void);
extern Boolean MA_chop_stack(void);
extern Boolean MA_free_heap(void);
extern Boolean MA_free_heap_piece(void);
extern Boolean MA_get_index(void);
extern Pointer MA_get_mbase(void);
extern Boolean MA_get_next_memhandle(void);
extern Boolean MA_get_numalign(void);
extern Boolean MA_get_pointer(void);
extern Boolean MA_init(void);
extern Boolean MA_initialized(void);
extern Boolean MA_init_memhandle_iterator(void);
extern Integer MA_inquire_avail(void);
extern Integer MA_inquire_heap(void);
extern Integer MA_inquire_heap_check_stack(void);
extern Integer MA_inquire_heap_no_partition(void);
extern Integer MA_inquire_stack(void);
extern Integer MA_inquire_stack_check_heap(void);
extern Integer MA_inquire_stack_no_partition(void);
extern Boolean MA_pop_stack(void);
extern void MA_print_stats(void);
extern Boolean MA_push_get(void);
extern Boolean MA_push_stack(void);
extern Boolean MA_set_auto_verify(void);
extern Boolean MA_set_error_print(void);
extern Boolean MA_set_hard_fail(void);
extern Boolean MA_set_numalign(void);
extern Integer MA_sizeof(void);
extern Integer MA_sizeof_overhead(void);
extern void MA_summarize_allocated_blocks(void);
extern void MA_trace(void);
extern Boolean MA_verify_allocator_stuff(void);
#endif

extern void ma_set_error_callback(void);
